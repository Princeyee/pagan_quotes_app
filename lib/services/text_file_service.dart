...
for (int i = 1; i < paragraphs.length; i++) {
  ...
  BookSource? findBookSource(String author, String title) {
    ...
    // ОСОБАЯ ОБРАБОТКА ДЛЯ АВТОРОВ С НЕСКОЛЬКИМИ КНИГАМИ
    // Если автор имеет несколько книг, проверяем точное совпадение названия
    final multiBookAuthors = [
      'аристотель', 'ницше', 'платон', 'хайдеггер', 'шопенгауэр', 
      'эвола', 'элиаде', 'askr svarte', 'де бенуа'
    ];
    
    if (multiBookAuthors.contains(normalizedAuthor)) {
      for (final source in sources) {
        final sourceAuthor = _normalizeString(source.author);
        final sourceTitle = _normalizeString(source.title);
        
        if (_authorsMatch(sourceAuthor, normalizedAuthor) && _titlesMatch(sourceTitle, normalizedTitle)) {
          print('✅ Книга автора с несколькими произведениями: ${source.title}');
          return source;
        }
      }
    }
  ...
  bool _authorsMatch(String sourceAuthor, String queryAuthor) {
    ...
    // ПОЛНЫЙ МАППИНГ сокращенных имен к полным
    final authorMappings = {
      // Философы
      'хайдеггер': 'мартин хайдеггер',
      'мартин хайдеггер': 'мартин хайдеггер',
      'ницше': 'фридрих ницше',
      ...
      // Современные авторы
      'элиаде': 'мирча элиаде',
      'мирча элиаде': 'мирча элиаде',
      'эвола': 'юлиус эвола',
      'юлиус эвола': 'юлиус эвола',
      'askr svarte': 'askr svarte евгений ничкасов',
      'askr svarte (евгений ничкасов)': 'askr svarte евгений ничкасов',
      'евгений ничкасов': 'askr svarte евгений ничкасов',
      'де бенуа': 'ален де бенуа',
      'ален де бенуа': 'ален де бенуа',
      
      // Северные авторы
      'мифопоэтика': 'мифопоэтика',
      'старшая эдда': 'старшая эдда',
      'беовульф': 'беовульф',
    };
  ...
  bool _titlesMatch(String sourceTitle, String queryTitle) {
    ...
    // ПОЛНЫЙ МАППИНГ сокращенных названий к полным
    final titleMappings = {
      // Аристотель
      'метафизика': 'метафизика',
      'этика': 'никомахова этика',
      'никомахова этика': 'никомахова этика',
      'политика': 'политика',
      'риторика': 'риторика',
      ...
      'антихрист': 'антихрист',
      'веселая наука': 'веселая наука',
      'рождение трагедии': 'рождение трагедии из духа музыки',
      'рождение трагедии из духа музыки': 'рождение трагедии из духа музыки',
      'по ту сторону добра и зла': 'по ту сторону добра и зла',
      ...
      // Хайдеггер
      'бытие и время': 'бытие и время',
      'что значит мыслить': 'что значит мыслить',
      'что значит мыслить?': 'что значит мыслить',
      
      // Шопенгауэр
      'мир как воля': 'мир как воля и представление',
      'мир как воля и представление': 'мир как воля и представление',
      'афоризмы': 'афоризмы житейской мудрости',
      'афоризмы житейской мудрости': 'афоризмы житейской мудрости',
      
      // Эвола
      'языческий империализм': 'языческий империализм',
      'метафизика пола': 'метафизика пола',
      'люди и руины': 'люди и руины',
      ...
      'история веры и религиозных идей том 1': 'история веры и религиозных идей том 1',
      'история веры и религиозных идей том 2': 'история веры и религиозных идей том 2',
      'история веры и религиозных идей том 3': 'история веры и религиозных идей том 3',
      'священное и мирское': 'священное и мирское',
      'миф о вечном возвращении': 'миф о вечном возвращении',
      
      // Askr Svarte
      'идентичность язычника': 'идентичность язычника в 21 веке',
      'идентичность язычника в 21 веке': 'идентичность язычника в 21 веке',
      'приближение и окружение': 'приближение и окружение',
      'polemos': 'polemos',
      ...
      // Гесиод
      'труды и дни': 'труды и дни',
      
      // Ален де Бенуа
      'как можно быть язычником': 'как можно быть язычником',
    };

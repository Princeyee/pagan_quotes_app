              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    'Философия начинается с удивления, язык - дом бытия. Цитата - то что пробуждает удивление, цепляет и ведет за собой. Перевернутая картина погружения в язык через отрывок - то что может вынуть человека из рутины.',
                    style: GoogleFonts.merriweather(
                      fontSize: 15,
                      height: 1.6,

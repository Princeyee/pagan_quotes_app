...
# 🔧 Скрипт для настройки Google APIs
# Этот скрипт поможет вам настроить необходимые API в Google Cloud Console

echo "🚀 Настройка Google APIs для проекта Flutter"
echo "============================================="

PROJECT_ID="sinuous-transit-460717-j9"
PACKAGE_NAME="com.yourcompany.dailyquotes"
SHA1_FINGERPRINT="E8:39:D8:08:6A:81:8A:E4:ED:AB:3F:9C:25:9B:47:34:DE:37:C3:7E"
...
echo "grep -n 'applicationId\\|namespace' android/app/build.gradle.kts"
echo ""

echo "Проверка google-services.json:"
echo "grep -n 'package_name' android/app/google-services.json"
echo ""
